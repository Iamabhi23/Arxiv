...
import sys
sys.path.append('../src')
from arsearch import ArchiveSearchPapers

# Load the model for the app 
AS = ArchiveSearchPapers(path = '../models/papers') # this is where you swtich between the papers model and the abstract model.
